...
export let placeholderLeads: Lead[] = [
  {
    ...
    dhowAdultQty: 10, // Mapped to adultStandardRate (129 from DO-yacht1) = 1290
  ...
  },
  {
    ...
    oeAdultQty: 10, // Mapped to adultStandardRate (135 from DO-yacht2) = 1350
  ...
  {
    id: 'DO-lead3', agent: 'DO-agentA', status: 'Conformed', month: formatISO(new Date('2024-08-10T12:00:00Z')), yacht: 'DO-yacht1',
  ...
  },
  {
    ...
    dhowVipQty: 20, // Mapped to vipAdultRate (189 from DO-yacht1) = 3780
    othersAmtCake: 100, // Assuming othersAmtCake_rate on yacht1 is 100
  ...
  },
  {
    ...
    dhowChildQty: 10, // Mapped to childRate (89 from DO-yacht1) = 890
    dhowAdultQty: 10, // Mapped to adultStandardRate (129 from DO-yacht1) = 1290
  ...
  },
   {
    ...
    oeVipQty: 5, // Mapped to vipAdultRate (195 from DO-yacht2) = 975
