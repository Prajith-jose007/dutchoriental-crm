    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Monthly 'Confirmed' booking trends for the last 7 months.</CardDescription>
        </CardHeader>
  ...
  if (chartData.length === 0 && !isLoading) {
    return (
        <Card>
            ...
            <CardContent className="flex items-center justify-center h-[300px]">
                <p className="text-muted-foreground">No 'Confirmed' booking data available for the selected period or filters.</p>
            </CardContent>
        </Card>
    );
  }
