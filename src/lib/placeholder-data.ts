...
export let placeholderYachts: Yacht[] = [
  ...
  },
  {
    ...
    royalAdultRate: 320,
    royalDrinksRate: 400,
    // No otherChargeName/Rate specified for this yacht, will default to undefined/0
    customPackageInfo: ""
  },
];
...
export let placeholderLeads: Lead[] = [
  {
    id: 'DO-lead1', agent: 'DO-AGENT-001', status: 'Conformed', month: formatISO(parseISO('2024-07-15T10:00:00Z')), notes: 'Confirmed booking, client very happy.', yacht: 'DO-yacht1',
    ...
    createdAt: formatISO(parseISO('2024-06-15T10:00:00Z')), updatedAt: formatISO(parseISO('2024-07-01T10:00:00Z')), lastModifiedByUserId: 'DO-user1', ownerUserId: 'DO-user1'
  },
  {
    id: 'DO-lead2', agent: 'DO-AGENT-002', status: 'Upcoming', month: formatISO(parseISO('2024-07-25T14:30:00Z')), notes: 'Follow up next week.', yacht: 'DO-yacht2',
    ...
    createdAt: formatISO(parseISO('2024-06-20T10:00:00Z')), updatedAt: formatISO(parseISO('2024-07-05T10:00:00Z')), lastModifiedByUserId: 'DO-user2', ownerUserId: 'DO-user2'
  },
  {
    id: 'DO-lead3', agent: 'DO-AGENT-001', status: 'Conformed', month: formatISO(parseISO('2024-08-10T12:00:00Z')), yacht: 'DO-yacht1',
    type: 'Tour Group', modeOfPayment: 'Cash/Card', clientName: 'Solutions Inc',
    qty_adultStandardRate: 10, // 10 * 129 (from DO-yacht1) = 1290
    totalAmount: 1290, commissionPercentage: 10, commissionAmount: 129,
    netAmount: 1161, paidAmount: 1290, balanceAmount: 0,
    createdAt: formatISO(parseISO('2024-07-10T10:00:00Z')), updatedAt: formatISO(parseISO('2024-07-12T10:00:00Z')), lastModifiedByUserId: 'DO-user1', ownerUserId: 'DO-user1'
  },
  {
    id: 'DO-lead4', agent: 'DO-AGENT-001', status: 'Upcoming', month: formatISO(parseISO('2024-08-20T18:00:00Z')), yacht: 'DO-yacht1',
    ...
    createdAt: formatISO(parseISO('2024-07-20T10:00:00Z')), updatedAt: formatISO(parseISO('2024-07-20T10:00:00Z')), lastModifiedByUserId: 'DO-user3', ownerUserId: 'DO-user3'
  },
  {
    id: 'DO-lead5', agent: 'DO-AGENT-002', status: 'Balance', month: formatISO(parseISO('2024-09-05T16:00:00Z')), yacht: 'DO-yacht1',
    ...
    createdAt: formatISO(parseISO('2024-08-10T10:00:00Z')), updatedAt: formatISO(parseISO('2024-08-15T10:00:00Z')), lastModifiedByUserId: 'DO-user2', ownerUserId: 'DO-user2'
  },
   {
    id: 'DO-lead6', agent: 'DO-AGENT-001', status: 'Closed', month: formatISO(parseISO('2024-05-05T16:00:00Z')), yacht: 'DO-yacht2',
    ...
    createdAt: formatISO(parseISO('2024-04-10T10:00:00Z')), updatedAt: formatISO(parseISO('2024-04-15T10:00:00Z')), lastModifiedByUserId: 'DO-user1', ownerUserId: 'DO-user1'
  }
];
...
export let placeholderInvoices: Invoice[] = [
  ...
  { id: 'DO-inv003', leadId: 'DO-lead3', clientName: 'Solutions Inc', amount: 1290, dueDate: formatISO(new Date('2024-07-25')), status: 'Pending', createdAt: formatISO(new Date('2024-06-10')) }, 
  { id: 'DO-inv004', leadId: 'DO-lead4', clientName: 'Global Co', amount: 3930, dueDate: formatISO(new Date('2024-09-01')), status: 'Pending', createdAt: formatISO(new Date('2024-07-15')) },
